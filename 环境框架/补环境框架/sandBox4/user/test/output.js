...
//浏览器具体接口实现
xzvm.envFunc.EventTarget_addEventListener = function EventTarget_addEventListener(){
...
xzvm.toolsFunc.defineProperty(window,"name",{
        configurable: true,
        enumerable: true,
        get: function (){},
        set: function (){}
...
//输入
debugger;
let r=window.addEventListener("load", function xxx() {
})
console.log(r);
//异步执行相关
