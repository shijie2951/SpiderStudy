...
//hook全局对象
xz.hookGlobal = function hookGlobal(isDebug) {
    for (key in Object.getOwnPropertyDescriptors(window)) {
        if (typeof window[key] === "function") {
            if (typeof window[key].prototype === "object") {
                //函数原型
                xz.hookProto(window[key], isDebug);
                ...
                xz.hook(window[key], funcInfo, isDebug);
            }
        }
    }
}
